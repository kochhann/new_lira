...
function process_response(cidades){
    func_select = document.getElementById('cidade_ddl');
    func_select.innerHTML = "";

    cidades.forEach(function(cidade){
        var option = document.createElement("option");
        option.text = cidade.fields.name;
        option.value = cidade.pk;
        func_select.add(option);
    });
}

function filtra_cidade(){
    estado_id = document.getElementById('estado_ddl').value;
    $.ajax({
        type: 'GET',
        url: 'load-cidades',
        data: {
            outro_param: estado_id
        },
        success: function(result){
            process_response(result);
            $("#mensagem").text('Cidades carregadas');
        }
    });
}

function filtra_cidade_oncreate(){
    estado_id = document.getElementById('estado_ddl').value;
    $.ajax({
        type: 'GET',
        url: 'load-cidades-oncreate',
        data: {
            outro_param: estado_id
        },
        success: function(result){
